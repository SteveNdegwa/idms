...
class RolePermissionAdmin(admin.ModelAdmin):
	...
	search_fields = ('id', 'role__name', 'permission__name')
...
class ProfileAdmin(admin.ModelAdmin):
	...
	search_fields = (
		'id', 'id_no', 'other_phone_number', 'country__name', 'occupation', 'employment_type', 'country_of_work__name',
		'currency', 'state')
...
class UserAdmin(admin.ModelAdmin):
	...
	search_fields = (
		'id', 'username', 'first_name', 'last_name', 'other_name', 'gender', 'phone_number', 'email','systems__name',
